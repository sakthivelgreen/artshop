                    ...
                    <div id="regstep1">
                        ...
                        <form action="" method="post" name="contacts-form" id="contacts-form">
                            ...
                            <input type="text" name="fname" class="required"
                                value="<?php echo $row['customer_firstName']; ?>" /></br></br>
                            <strong>Lastname:</strong>
                            <input type="text" name="lname" class="required"
                                value="<?php echo $row['customer_lastName']; ?>" /></br></br>
                            ...
                            <input type="tel" name="contactno" maxlength="10" class="required"
                                onKeyPress="return isNumberKey(event)"
                                value="<?php echo $row['contact_no']; ?>" /></br></br>
                            <strong>Birthdate: (DD MM YY)</strong>
                            <input type="date" name="bday" class="required" value="<?php echo $row['dob']; ?>" />
                            </br></br>
                    ...
                    <div id="form_row1">
                        ...
                        <form action="" method="post" name="contacts-form" id="contacts-form"
                            ...
                            <input type="password" name="pass1" id="pass1" class="required"
                                onKeyUp="checkPass(); return false;" required/></br></br>
                            <strong>Confirm Password:</strong>
                            <input type="password" name="pass2" id="pass2" onkeyup="checkPass(); return false;" required /><span
